...
const SESSION_STAGES = [
  ...
  { id: 'activation', name: "Activation", duration: 15, icon: Zap, color: "text-primary", activeColor: "bg-primary" },
    ...
    <div className="space-y-5">
              ...
              return (
                <button 
                  ...
                  className={cn(
                    ...
                    "bg-card/5 border-primary-foreground/10 hover:bg-card/10"
                  )}
                >
                  <div className="flex items-center gap-4">
                    <div className={cn(
                      "w-8 h-8 rounded-lg flex items-center justify-center transition-all duration-500",
                      isActive ? "bg-card/20" : isDone ? "bg-emerald-500 text-primary-foreground" : "bg-card/5",
      ...
      {currentPeakMeridian && (
          <Tooltip>
            ...
            <TooltipContent side="top" className="rounded-xl p-3 bg-foreground text-primary-foreground border-none shadow-sm max-w-[200px]">
      ...
      <Collapsible open={billingOpen} onOpenChange={setBillingOpen}>
        <Card className={cn(
          ...
          appointment.is_paid ? "bg-card border-2 border-emerald-100" : "bg-muted border border-border"
        )}>
              ...
              <div className="flex items-center justify-between p-5 bg-card dark:bg-foreground rounded-xl border border-border dark:border-border shadow-sm">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant="outline" className="h-4 px-1.5 text-[6px] font-medium uppercase border-border text-muted-foreground/70">
                ...
                <div className="space-y-6 animate-in zoom-in-95 duration-500">
                  {!appointment.payment_received ? (
                    ...
                    <div className="p-5 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl border border-emerald-100 dark:border-emerald-800 flex flex-col items-center justify-center gap-4 text-emerald-700">
                      <div className="w-16 h-16 rounded-full bg-emerald-500 text-primary-foreground flex items-center justify-center shadow-sm shadow-emerald-500/30">
      ...
      <Collapsible open={contextOpen} onOpenChange={setContextOpen}>
        <Card className="border-none shadow-sm shadow-slate-900/5 rounded-xl bg-foreground text-primary-foreground overflow-hidden">
          <CollapsibleTrigger asChild>
            <CardHeader className="p-5 cursor-pointer hover:bg-card/5 transition-colors">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <EditableField 
                    ...
                    className="bg-card/5 border-primary-foreground/10 p-5 rounded-xl text-sm"
                  />
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <EditableField 
                    ...
                    multiline 
                    className="bg-amber-500/10 border-amber-500/20 p-5 rounded-xl text-sm italic text-muted-foreground/60" 
