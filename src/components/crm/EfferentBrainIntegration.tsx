            ...
            <div className="bg-indigo-900 text-white p-8 rounded-[2.5rem] shadow-2xl relative overflow-hidden">
              ...
              <div className="space-y-8 relative z-10">
                ...
                <div className="flex items-center justify-center gap-4">
                  ...
                  <div className="flex-1 space-y-3">
                    <div className="p-4 bg-white/10 rounded-2xl border border-white/10 text-center">
                      ...
                      <p className="text-lg font-bold truncate">{coord1.side} {coord1.point?.name}</p>
                    </div>
                  ...
                  <div className="flex-1 space-y-3">
                    <div className="p-4 bg-white/10 rounded-2xl border border-white/10 text-center">
                      ...
                      <p className="text-lg font-bold truncate">{coord2.side} {coord2.point?.name}</p>
                    </div>
                ...
                <div className="p-6 bg-white rounded-3xl text-slate-900 shadow-xl">
                  <p className="text-xs font-black text-slate-400 uppercase tracking-widest mb-3">Instructions: {method}</p>
                  <div className="space-y-4">
                    {method === 'Tapping' && (
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                        <p className="text-lg font-bold leading-tight">
                          Simultaneously <span className="text-indigo-600">TAP</span> both reflex points.
                        </p>
                    ...
                    {method === 'Holding + Intention' && (
                      <div className="space-y-4">
                        ...
                        <p className="text-xs text-slate-500 text-center">Continue until you feel a therapeutic pulse or a sense of release.</p>
                      </div>
                    )}
                    {method === 'Tuning Fork' && (
                      <p className="text-lg font-bold leading-tight">
