  ...
  return (
    <div className="space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="space-y-1.5">
            ...
            <ToggleGroup type="single" value={driftDirection} onValueChange={handleDriftChange} className="justify-start gap-1">
              <ToggleGroupItem value="Left" className="rounded-lg border border-slate-200 text-xs font-bold px-3 py-1.5 data-[state=on]:bg-indigo-600 data-[state=on]:text-white">L</ToggleGroupItem>
              <ToggleGroupItem value="Right" className="rounded-lg border border-slate-200 text-xs font-bold px-3 py-1.5 data-[state=on]:bg-indigo-600 data-[state=on]:text-white">R</ToggleGroupItem>
              <ToggleGroupItem value="Forward" className="rounded-lg border border-slate-200 text-xs font-bold px-3 py-1.5 data-[state=on]:bg-indigo-600 data-[state=on]:text-white">Fwd</ToggleGroupItem>
            </ToggleGroup>
          </div>
          <div className="space-y-1.5">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <Label htmlFor="fakudaNotes" className="text-sm font-bold text-slate-900 flex items-center gap-2">
          ...
          <div className="flex items-center justify-between p-3 hover:bg-slate-50 transition-colors cursor-pointer">
            <div className="flex items-center gap-2">
              ...
              <div className="text-left">
                ...
                <p className="text-[10px] text-slate-400 font-medium">Fakuda (Fukuda) Step Test protocol & images</p>
              </div>
            </div>
