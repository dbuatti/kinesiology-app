...
const HubSwitcher = () => {
  ...
  const handleSwitch = (newMode: AppMode) => {
    setMode(newMode);
    navigate(newMode === 'business' ? '/business/dashboard' : '/');
  };
  ...
  return (
    <div className="flex items-center">
      <button
        ...
        className={cn(
          "flex items-center gap-2 sm:gap-3 px-2.5 py-2 sm:px-4 rounded-2xl border transition-all duration-500 hover:shadow-lg group cursor-pointer",
          activeMode.color
        )}
      >
