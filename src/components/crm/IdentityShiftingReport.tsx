    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-3xl font-serif font-bold text-foreground">Session Report</h2>
            <p className="text-muted-foreground font-medium">The evolution of "{session.identity}"</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 gap-4 pt-4 border-t border-border/30">
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-bold text-foreground/80">{session.emotion || 'Not specified'}</p>
                </div>
                <div className="space-y-1">
          ...
          <Card className="border-none shadow-lg rounded-2xl bg-indigo-900 text-primary-foreground overflow-hidden">
            <CardContent className="p-8 text-center space-y-4">
              <p className="text-[10px] font-semibold text-indigo-300 uppercase tracking-wider">The Identity</p>
        ...
        <div className="lg:col-span-2 space-y-8">
              ...
              {session.loop_responses?.map((response: string, index: number) => (
                <div key={index} className="flex gap-4 group">
                  <div className="flex flex-col items-center">
                    <div className="w-8 h-8 rounded-full bg-indigo-50 border border-indigo-100 flex items-center justify-center text-[10px] font-semibold text-indigo-600 shrink-0">
                      {index + 1}
                    </div>
          ...
          <div className="p-6 bg-foreground text-primary-foreground rounded-2xl flex items-start gap-6 shadow-xl">
            ...
            <div className="space-y-1">
              <h4 className="text-sm font-semibold text-indigo-400 uppercase tracking-wider">Clinical Reflection</h4>
