    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <Card className="border-none shadow-md rounded-[2rem] bg-card overflow-hidden">
            ...
            <CardContent className="p-6 space-y-6">
              <div className="space-y-2">
                <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Original Problem</p>
          ...
          <div className="space-y-4">
            <Card className="border-none shadow-lg rounded-[2rem] bg-rose-900 text-primary-foreground overflow-hidden">
            ...
            <Card className="border-none shadow-lg rounded-[2rem] bg-emerald-900 text-primary-foreground overflow-hidden">
              <CardContent className="p-8 text-center space-y-4">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <section className="space-y-4">
            <h3 className="text-xl font-black text-foreground px-2 flex items-center gap-3">
              <RotateCcw size={20} className="text-indigo-600" /> The Dissolving Loop
            </h3>
            <div className="space-y-6">
              {session.dissolve_log?.map((log: any, index: number) => (
                <div key={index} className="space-y-3 p-6 bg-card rounded-[2rem] border border-border/50 shadow-sm">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[10px] font-black text-muted-foreground/60 uppercase tracking-widest">Cycle {Math.floor(index / 2) + 1}</span>
                  </div>
                  
                  <div className="space-y-4">
                    <div>
                      <p className="text-[9px] font-black text-muted-foreground uppercase tracking-widest mb-1">Identity</p>
                      <p className="text-sm font-bold text-foreground italic">"{log.identity}"</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <p className="text-[9px] font-black text-muted-foreground uppercase tracking-widest mb-1">First Notice</p>
                        <p className="text-xs text-muted-foreground leading-relaxed">{log.notice1}</p>
                      </div>
                      <div>
                        <p className="text-[9px] font-black text-muted-foreground uppercase tracking-widest mb-1">Second Notice</p>
          ...
          <div className="p-6 bg-foreground text-primary-foreground rounded-[2.5rem] flex items-start gap-6 shadow-xl">
