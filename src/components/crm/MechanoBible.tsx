    ...
    <div className="space-y-12 animate-in fade-in duration-700">
        ...
        <CardHeader className="p-12 relative z-10">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-5">
              ...
              <div>
                <CardTitle className="text-4xl font-semibold tracking-tight">The Mechano Bible</CardTitle>
            ...
            <Button 
              ...
              className="bg-card text-indigo-600 hover:bg-indigo-50 h-14 px-8 rounded-2xl font-semibold text-xs shadow-xl"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card className="border border-border shadow-sm rounded-2xl bg-card overflow-hidden">
          ...
          <CardContent className="p-8 space-y-6">
            <div className="p-6 bg-emerald-900 text-primary-foreground rounded-2xl shadow-xl relative overflow-hidden">
      ...
      <div className="space-y-8">
        <h3 className="text-2xl font-semibold text-foreground px-2 flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 px-4">
              ...
              <h4 className="font-semibold text-primary uppercase tracking-wider text-sm">Conscious (DCML)</h4>
            </div>
              ...
              <Card key={i} className="border-none shadow-md rounded-2xl bg-card overflow-hidden border-l-4 border-primary">
                <CardContent className="p-6 space-y-4">
                  <div className="flex justify-between items-start">
                    <h5 className="font-semibold text-foreground text-lg">{ex.title}</h5>
                    <Badge className="bg-primary/5 text-primary border-none text-[10px] font-semibold uppercase">{ex.logic}</Badge>
                  </div>
                  ...
                  <div className="pt-3 border-t border-border/30">
                    <p className="text-[10px] font-semibold text-primary uppercase tracking-wider mb-1">Protocol</p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 px-4">
              ...
              <h4 className="font-semibold text-emerald-900 uppercase tracking-wider text-sm">Unconscious (Spinocerebellar)</h4>
            </div>
            {unconsciousExamples.map((ex, i) => (
              <Card key={i} className="border-none shadow-md rounded-2xl bg-card overflow-hidden border-l-4 border-emerald-500">
                <CardContent className="p-6 space-y-4">
                  <div className="flex justify-between items-start">
                    <h5 className="font-semibold text-foreground text-lg">{ex.title}</h5>
                    <Badge className="bg-emerald-50 text-emerald-700 border-none text-[10px] font-semibold uppercase">{ex.logic}</Badge>
                  </div>
                  ...
                  <div className="pt-3 border-t border-border/30">
                    <p className="text-[10px] font-semibold text-emerald-600 uppercase tracking-wider mb-1">Protocol</p>
                    <p className="text-xs text-muted-foreground leading-relaxed font-medium">{ex.protocol}</p>
                  </div>
                </CardContent>
              </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card className="border border-border shadow-sm rounded-2xl bg-card overflow-hidden group hover:shadow-xl transition-all">
            ...
            <CardHeader className="p-8">
              <div className="flex items-center justify-between">
                <CardTitle className="text-2xl font-semibold text-foreground">Ligaments</CardTitle>
                <Shield size={32} className="text-emerald-500" />
              </div>
              <p className="text-emerald-600 font-semibold text-[10px] uppercase tracking-wider">Bone to Bone</p>
            </CardHeader>
          ...
          <Card className="border border-border shadow-sm rounded-2xl bg-card overflow-hidden group hover:shadow-xl transition-all">
            ...
            <CardHeader className="p-8">
              <div className="flex items-center justify-between">
                <CardTitle className="text-2xl font-semibold text-foreground">Tendons</CardTitle>
                <LinkIcon size={32} className="text-rose-500" />
              </div>
              <p className="text-rose-600 font-semibold text-[10px] uppercase tracking-wider">Muscle to Bone</p>
            </CardHeader>
            <CardContent className="p-8 pt-0 space-y-6">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <Card key={plane.title} className="border-none shadow-lg rounded-2xl bg-card overflow-hidden">
              <div className={cn("p-6 text-primary-foreground", plane.color)}>
                <h4 className="text-xl font-semibold">{plane.title} Plane</h4>
              ...
              <CardContent className="p-6 space-y-4">
                <div className={cn("p-3 rounded-xl border", plane.light, plane.border)}>
                  <p className={cn("text-[10px] font-semibold uppercase tracking-wider mb-1", plane.text)}>Core Logic</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.term} className="space-y-1">
                <h5 className="font-semibold text-indigo-600 text-sm uppercase tracking-tight">{item.term}</h5>
      ...
      <div className="p-8 bg-amber-50 rounded-2xl border-2 border-amber-100 flex items-start gap-6">
        ...
        <div className="space-y-2">
          <h4 className="text-xl font-semibold text-amber-900">Practitioner Pro-Tip</h4>
