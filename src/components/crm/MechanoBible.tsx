    ...
    <div className="space-y-12 animate-in fade-in duration-700">
        ...
        <CardHeader className="p-12 relative z-10">
          <div className="flex items-center justify-between">
            ...
            <Button 
              ...
              className="bg-card text-indigo-600 hover:bg-indigo-50 h-14 px-8 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-center gap-4 p-4 bg-muted/50 rounded-2xl border border-border/50">
                  <span className="w-8 h-8 rounded-full bg-indigo-600 text-primary-foreground flex items-center justify-center font-black text-xs">{i + 1}</span>
                  <div>
                    <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">{step.label}</p>
        ...
        <Card className="border-none shadow-lg rounded-[2.5rem] bg-card overflow-hidden">
          ...
          <CardContent className="p-8 space-y-6">
            <div className="p-6 bg-emerald-900 text-primary-foreground rounded-[2rem] shadow-xl relative overflow-hidden">
            ...
            <div className="grid grid-cols-3 gap-3">
              {["Sagittal", "Frontal", "Transverse"].map(plane => (
                <div key={plane} className="p-4 bg-muted/50 rounded-2xl border border-border/50 text-center">
                  <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-1">Plane</p>
                  <p className="text-xs font-black text-foreground">{plane}</p>
                </div>
              ))}
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 px-4">
              ...
              <h4 className="font-black text-primary uppercase tracking-widest text-sm">Conscious (DCML)</h4>
            </div>
            {consciousExamples.map((ex, i) => (
              <Card key={i} className="border-none shadow-md rounded-2xl bg-card overflow-hidden border-l-4 border-primary">
                <CardContent className="p-6 space-y-4">
                  <div className="flex justify-between items-start">
                    <h5 className="font-black text-foreground text-lg">{ex.title}</h5>
                    <Badge className="bg-primary/5 text-primary border-none text-[8px] font-black uppercase">{ex.logic}</Badge>
                  </div>
                  
                  <div className="p-3 bg-muted/50 rounded-xl border border-border/50">
                    <p className="text-[9px] font-black text-muted-foreground uppercase tracking-widest mb-1">Localization Path</p>
                    <p className="text-xs font-bold text-indigo-600">{ex.localization}</p>
                  </div>

                  <div className="grid grid-cols-2 gap-4 text-xs">
                    <div>
                      <p className="text-muted-foreground font-bold uppercase tracking-widest text-[9px]">Plane</p>
                      <p className="font-bold text-foreground/80">{ex.plane}</p>
                    </div>
                    <div>
                      <p className="text-muted-foreground font-bold uppercase tracking-widest text-[9px]">Action</p>
                      <p className="font-bold text-foreground/80">{ex.action}</p>
                    </div>
                  </div>
                  <div className="pt-3 border-t border-border/30">
                    <p className="text-[9px] font-black text-primary uppercase tracking-widest mb-1">Protocol</p>
                    <p className="text-xs text-muted-foreground leading-relaxed font-medium">{ex.protocol}</p>
                  </div>
                </CardContent>
              </Card>
            ))}
          ...
          <div className="space-y-4">
            ...
            {unconsciousExamples.map((ex, i) => (
              <Card key={i} className="border-none shadow-md rounded-2xl bg-card overflow-hidden border-l-4 border-emerald-500">
                <CardContent className="p-6 space-y-4">
                  <div className="flex justify-between items-start">
                    <h5 className="font-black text-foreground text-lg">{ex.title}</h5>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-xs">
                    <div>
                      <p className="text-muted-foreground font-bold uppercase tracking-widest text-[9px]">Tissue</p>
                      <p className="font-bold text-foreground/80">{ex.tissue}</p>
                    </div>
                    <div>
                      <p className="text-muted-foreground font-bold uppercase tracking-widest text-[9px]">Stimulus</p>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card className="border-none shadow-lg rounded-[2.5rem] bg-card overflow-hidden group hover:shadow-xl transition-all">
            <div className="h-3 bg-emerald-500" />
            <CardHeader className="p-8">
              <div className="flex items-center justify-between">
                <CardTitle className="text-2xl font-black text-foreground">Ligaments</CardTitle>
            ...
            <CardContent className="p-8 pt-0 space-y-6">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-muted-foreground font-medium">Act as "Sensors" that tell the cerebellum where the joint is in space.</p>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 size={18} className="text-emerald-500 shrink-0 mt-0.5" />
                  <p className="text-sm text-muted-foreground font-medium">When stretched or injured, they send a "Threat" signal to the brain.</p>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 size={18} className="text-emerald-500 shrink-0 mt-0.5" />
                  <p className="text-sm text-muted-foreground font-medium"><strong>Correction:</strong> Stretch the ligament while holding GV16 (Cerebellum).</p>
                </li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card className="border-none shadow-lg rounded-[2.5rem] bg-card overflow-hidden group hover:shadow-xl transition-all">
            ...
            <CardHeader className="p-8">
              <div className="flex items-center justify-between">
                <CardTitle className="text-2xl font-black text-foreground">Tendons</CardTitle>
            ...
            <CardContent className="p-8 pt-0 space-y-6">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-muted-foreground font-medium">House the Golgi Tendon Organs (GTOs) which monitor muscle tension.</p>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 size={18} className="text-rose-500 shrink-0 mt-0.5" />
                  <p className="text-sm text-muted-foreground font-medium">Protect the muscle from tearing by inhibiting it if tension is too high.</p>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 size={18} className="text-rose-500 shrink-0 mt-0.5" />
                  <p className="text-sm text-muted-foreground font-medium"><strong>Correction:</strong> Isometric contraction (30-40%) to reset the GTO threshold.</p>
                </li>
              </ul>
            </CardContent>
          </Card>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <Card key={plane.title} className="border-none shadow-lg rounded-[2rem] bg-card overflow-hidden">
              <div className={cn("p-6 text-primary-foreground", plane.color)}>
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-2">
                  <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Key Movements</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.term} className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground font-medium leading-relaxed">{item.def}</p>
              </div>
            ))}
          </div>
        </CardContent>
