...
const REGIONS = [
  { id: 'All', label: 'Full Body', icon: LayoutGrid, color: 'text-slate-500' },
  ...
  { id: 'Lower Leg & Foot', label: 'Feet & Ankles', icon: Footprints, color: 'text-blue-500' },
];
        ...
        return (
          ...
          >
            <div className={cn(
              ...
              isActive ? "bg-white/20" : "bg-slate-50 group-hover:scale-110"
            )}>
              <region.icon size={20} className={cn(isActive ? "text-white" : region.color)} />
            </div>
