      ...
      case 'MECHANO_CONSCIOUS_PROCESS':
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="p-4 bg-blue-50 border border-blue-100 rounded-xl text-sm text-blue-800 space-y-2"><p className="font-bold">3. Perform Correction:</p><p>Place joint into priority action. Perform an isometric contraction (30-40% effort) for 3-5 seconds with nasal breathing.</p></div>
      ...
      case 'MECHANO_UNCONSCIOUS_PROCESS':
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="p-4 bg-emerald-50 border border-emerald-100 rounded-xl text-sm text-emerald-800 space-y-2"><p className="font-bold">3. Perform Correction:</p><p>Stretch the priority ligament/tendon while holding GV16. Apply a tuning fork to the cranium or tap for 3-5 seconds.</p></div>
