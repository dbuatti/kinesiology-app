...
const PractitionerGrounding = ({ onComplete, onCancel }: PractitionerGroundingProps) => {
  ...
  return (
    <Card className="border-none shadow-2xl rounded-[3rem] bg-foreground text-primary-foreground overflow-hidden relative group min-h-[400px] flex flex-col justify-center">
      ...
      <CardContent className="p-10 relative z-10">
        <AnimatePresence mode="wait">
          {!isActive && phase !== 'complete' ? (
            ...
            >
              <div className="w-20 h-20 rounded-[2rem] bg-card/5 backdrop-blur-md flex items-center justify-center border border-primary-foreground/10 shadow-2xl">
              ...
              <div className="flex gap-4">
                ...
                <Button 
                  ...
                  className="bg-card text-foreground hover:bg-indigo-50 h-14 px-12 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl transition-all hover:scale-105 active:scale-95"
                >
                  Start Centering
                </Button>
              </div>
            ...
            >
              ...
              <Button variant="ghost" onClick={resetGrounding} className="text-indigo-300 hover:text-primary-foreground hover:bg-card/5 font-black text-[10px] uppercase tracking-widest h-12 px-8 rounded-2xl border border-primary-foreground/10">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-xl bg-card/5 flex items-center justify-center shadow-inner border border-primary-foreground/10">
                ...
                <span className="text-sm font-black tabular-nums text-muted-foreground tracking-widest">{60 - totalElapsed}s</span>
              </div>
              ...
              <div className="flex flex-col items-center justify-center py-6 space-y-12">
                <div className="relative">
                  ...
                  <div className={cn(
                    "w-56 h-56 rounded-full border-2 border-primary-foreground/10 flex flex-col items-center justify-center transition-all duration-1000 shadow-2xl relative z-10 bg-foreground/50 backdrop-blur-sm",
                    phase === 'inhale' ? "scale-110 border-indigo-500/50" : "scale-100"
                  )}>
                    <p className="text-4xl font-black uppercase tracking-[0.2em] text-primary-foreground">
                      {phase}
                    </p>
                ...
                <div className="w-full max-w-md space-y-4">
                  ...
                  <div className="flex justify-between text-[9px] font-black uppercase tracking-[0.3em] text-muted-foreground">
              ...
              <div className="flex justify-center">
                <Button variant="ghost" onClick={resetGrounding} className="text-primary-foreground/20 hover:text-rose-400 hover:bg-rose-500/10 h-10 px-6 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all">
