        ...
        {LADDER_STEPS.map((step, i) => (
          <React.Fragment key={step.label}>
            <div className="flex flex-col items-center text-center min-w-[100px] group">
              ...
              <p className="mt-3 text-[10px] font-black text-slate-900 uppercase tracking-tight">{step.label}</p>
              <p className="text-[8px] text-slate-400 font-bold uppercase tracking-widest mt-0.5">{step.sub}</p>
            </div>
