        ...
        <Card className="lg:col-span-2 border-none shadow-sm rounded-xl bg-slate-900 text-white overflow-hidden relative">
          ...
          <CardHeader className="p-10">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <CardTitle className="text-3xl font-semibold">The Base Language of the Brain</CardTitle>
                <CardDescription className="text-muted-foreground text-lg font-medium mt-1">Neonatal Survival Reflexes & Development.</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="p-10 pt-0 space-y-10 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div className="p-5 bg-primary/20 rounded-xl border border-chart-primary/30">
                  <h4 className="font-medium text-chart-primary text-xs uppercase tracking-wider mb-2 flex items-center gap-2">
                    <Zap size={14} /> Fractal Logic
                  </h4>
                  <p className="text-xs text-chart-primary leading-relaxed">
            ...
            return (
              ...
              >
                <CardHeader className={cn(
                  ...
                  reflex.category === 'Foundational' ? "bg-muted/50 border-border" :
                  reflex.category === 'Postural' ? "bg-muted/50 border-border" :
                    ...
                    <div className="space-y-1">
                      <div className="flex gap-2 mb-2">
                        <Badge className={cn(
                          ...
                          reflex.category === 'Foundational' ? "bg-chart-primary/10 text-chart-primary" :
                          reflex.category === 'Postural' ? "bg-chart-emerald/10 text-chart-emerald" :
                ...
                <CardContent className="p-8 space-y-6">
                  ...
                  <div className="flex rounded-xl overflow-hidden border-2 border-border" onClick={(e) => e.stopPropagation()}>
                    <ReflexImageZone 
                      reflexId={reflex.id} 
                      type="primary"
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="p-4 bg-muted rounded-xl border border-border">
                      <p className="text-[10px] font-medium text-chart-destructive uppercase tracking-wider mb-1 flex items-center gap-1">
                        <ShieldAlert size={12} /> Inhibition Pattern
                      </p>
                      <p className="text-sm font-medium text-foreground leading-relaxed line-clamp-2">{reflex.inhibitionPattern}</p>
                    </div>
                  </div>
