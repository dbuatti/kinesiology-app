    ...
    <div className="bg-white text-black p-4 max-w-[297mm] mx-auto font-sans print:p-0 print:m-0">
      ...
      <div className="border-b-2 border-slate-900 pb-1 mb-2 flex justify-between items-end">
        <div>
          ...
          <p className="text-[9px] font-bold text-slate-500 uppercase tracking-[0.3em]">Clinical Assessment Log • Foundational OS</p>
        </div>
        ...
        <table className="w-full border-collapse text-[10px] leading-tight">
          <thead>
            <tr className="bg-slate-100 border-b border-black">
              <th className="p-1 text-left font-black uppercase border-r border-black w-[12%]">Reflex</th>
              <th className="p-1 text-center font-black uppercase border-r border-black w-[6%]">Inhib</th>
              <th className="p-1 text-left font-black uppercase border-r border-black w-[42%]">Stimulus & Inhibition Pattern</th>
              ...
              return (
                <tr key={reflex.id} className="break-inside-avoid">
                  <td className="p-1 border-r border-black bg-slate-50/30">
                    ...
                    <p className="font-bold text-[7px] text-slate-500 uppercase mt-0.5">{reflex.category}</p>
                  </td>
                  ...
                  <td className="p-1 border-r border-black align-top">
                    <div className="space-y-1">
                      <p className="text-[9px] leading-tight">
                        <span className="font-black uppercase text-slate-400 mr-1">Stim:</span>
                        {reflex.stimulus}
                      </p>
                      <p className="text-[9px] leading-tight font-bold text-slate-800">
      ...
      <div className="mt-2 p-2 border border-black bg-slate-50 flex justify-between items-start gap-8">
        <div className="space-y-1 flex-1">
          <h4 className="font-black text-[10px] uppercase tracking-widest border-b border-black/10 pb-0.5">Fractal Logic</h4>
        ...
        <div className="space-y-1 flex-[2]">
          <p className="text-[9px] font-black text-slate-400 uppercase">Primary Correction & Integration Plan:</p>
      ...
      <div className="mt-2 pt-0.5 border-t border-slate-200 text-center">
        <p className="text-[8px] font-black text-slate-300 uppercase tracking-[0.5em]">Resonance Clinical Infrastructure • Worksheet v1.2</p>
      </div>
