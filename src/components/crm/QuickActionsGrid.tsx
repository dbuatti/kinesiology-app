...
const QuickActionsGrid = ({ onNewClient, onBookSession }: QuickActionsGridProps) => {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      <Button 
        onClick={onNewClient}
        className="h-24 md:h-32 rounded-[2rem] bg-card dark:bg-foreground border border-border dark:border-border hover:border-indigo-500 hover:bg-indigo-50/30 text-indigo-600 flex flex-col gap-4 shadow-sm hover:shadow-2xl transition-all duration-500 group"
      >
      ...
      <Button 
        ...
        className="h-24 md:h-32 rounded-[2rem] bg-card dark:bg-foreground border border-border dark:border-border hover:border-rose-500 hover:bg-rose-50/30 text-rose-600 flex flex-col gap-4 shadow-sm hover:shadow-2xl transition-all duration-500 group"
      >
      ...
      <Link to="/practice/calibrate" className="block">
        <Button 
          className="w-full h-24 md:h-32 rounded-[2rem] bg-card dark:bg-foreground border border-border dark:border-border hover:border-amber-500 hover:bg-amber-50/30 text-amber-600 flex flex-col gap-4 shadow-sm hover:shadow-2xl transition-all duration-500 group"
        >
      ...
      <Link to="/practice/procedures" className="block">
        <Button 
          className="w-full h-24 md:h-32 rounded-[2rem] bg-card dark:bg-foreground border border-border dark:border-border hover:border-emerald-500 hover:bg-emerald-50/30 text-emerald-600 flex flex-col gap-4 shadow-sm hover:shadow-2xl transition-all duration-500 group"
        >
