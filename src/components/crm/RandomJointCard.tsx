        ...
        <div className="grid grid-cols-1 gap-2">
          <div className="flex items-center justify-between p-2.5 bg-muted/50 rounded-xl border border-border/50">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Sagittal</span>
            </div>
          ...
          <div className="flex items-center justify-between p-2.5 bg-muted/50 rounded-xl border border-border/50">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Frontal</span>
            </div>
            <span className="text-xs font-bold text-foreground/80">
          ...
          <div className="flex items-center justify-between p-2.5 bg-muted/50 rounded-xl border border-border/50">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Transverse</span>
            </div>
            <span className="text-xs font-bold text-foreground/80">
