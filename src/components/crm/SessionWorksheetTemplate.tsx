    ...
    <div className="hidden print:block p-8 bg-card text-foreground font-sans">
      <div className="flex justify-between items-end border-b-4 border-indigo-600 pb-6 mb-8">
        <div>
          ...
          <p className="text-muted-foreground font-medium text-xs mt-1">Antigravity Kinesiology Practice</p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="border-2 border-border/50 rounded-xl p-3 text-center">
          <p className="text-xs font-medium text-muted-foreground mb-2">BOLT Score</p>
          <div className="h-10 border-b border-border mx-4" />
        </div>
        <div className="border-2 border-border/50 rounded-xl p-3 text-center">
          <p className="text-xs font-medium text-muted-foreground mb-2">Coherence (HR/BR)</p>
          <div className="h-10 border-b border-border mx-4" />
        </div>
        <div className="border-2 border-border/50 rounded-xl p-3 text-center">
          <p className="text-xs font-medium text-muted-foreground mb-2">Hydration</p>
      ...
      <div className="mt-8 pt-8 border-t border-border/50 text-center">
        <p className="text-xs font-medium text-muted-foreground/60">Fractal Resolution • Antigravity CRM</p>
      </div>
    </div>
  );
};
