    ...
    <div className="space-y-10 animate-in fade-in duration-500">
        ...
        <CardContent className="p-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="space-y-2 text-center md:text-left">
              <Badge className="bg-amber-600 text-primary-foreground border-none font-black text-[9px] uppercase tracking-[0.3em] px-3 py-1">
                Daily Mission
              </Badge>
                ...
                <Link 
                  ...
                  className={cn(
                    ...
                    m.status === 'done'
                      ...
                      : "bg-muted/50 border-border/50 text-muted-foreground dark:bg-foreground/50 dark:border-border hover:border-amber-200 hover:bg-amber-50/30"
                  )}
                >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-8 space-y-10">
          <div className="p-10 bg-indigo-600 text-primary-foreground rounded-[2.5rem] shadow-md relative overflow-hidden">
            <div className="relative z-10 space-y-6">
              <div className="space-y-2">
                <Badge className="bg-card/20 text-primary-foreground border-none font-bold text-[10px] uppercase tracking-[0.3em] px-3 py-1">
                  Knowledge Mastery
                </Badge>
              ...
              <Button asChild className="bg-card text-indigo-600 hover:bg-indigo-50 h-12 px-8 rounded-xl font-bold text-xs uppercase tracking-widest shadow-lg">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-foreground dark:text-primary-foreground px-1">Clinical Reference</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Link to="/resources" className="block group">
                <Card className="border border-border dark:border-border shadow-sm rounded-[2rem] bg-card dark:bg-foreground hover:border-indigo-300 transition-all h-full">
                  <CardContent className="p-6 space-y-3">
                    <div className="w-9 h-9 rounded-xl bg-muted/50 dark:bg-foreground text-indigo-600 flex items-center justify-center border border-border/50 dark:border-border/50 group-hover:scale-110 transition-transform">
                      <BookOpen size={18} />
                    </div>
                    <h3 className="text-lg font-bold text-foreground dark:text-primary-foreground">Clinical Bible</h3>
              ...
              <Link to="/peace-framework" className="block group">
                <Card className="border border-border dark:border-border shadow-sm rounded-[2rem] bg-card dark:bg-foreground hover:border-indigo-300 transition-all h-full">
                  <CardContent className="p-6 space-y-3">
                    <div className="w-9 h-9 rounded-xl bg-muted/50 dark:bg-foreground text-rose-600 flex items-center justify-center border border-border/50 dark:border-border/50 group-hover:scale-110 transition-transform">
                      <ShieldCheck size={18} />
                    </div>
                    <h3 className="text-lg font-bold text-foreground dark:text-primary-foreground">PEACE Framework</h3>
                    <p className="text-xs text-muted-foreground dark:text-muted-foreground font-medium leading-relaxed">
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <Card className="border border-border dark:border-border shadow-sm rounded-[2rem] bg-card dark:bg-foreground overflow-hidden group">
