...
export const OUTLINE_ITEMS = [ /* ... your items */ ];
export const CORRECTIONS_GUIDE = [ /* ... your guides */ ];

const DocumentSidebar = ({ activeSection, scrollTo, openGuides, toggleGuide }: DocumentSidebarProps) => {
  return (
    <aside className="w-80 shrink-0">
      {/* Sticky Container */}
      <div className="sticky top-20 max-h-[calc(100vh-5rem)] overflow-hidden flex flex-col bg-slate-50 border border-slate-200 rounded-[2rem] print:hidden custom-scrollbar">
