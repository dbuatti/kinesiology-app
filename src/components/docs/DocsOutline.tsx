      ...
      <nav className="space-y-0.5">
        {items.map((item) => (
          <button
            ...
            className="w-full text-left px-4 py-2 text-[13px] text-slate-600 hover:bg-slate-200 rounded-r-full transition-colors border-l-2 border-transparent hover:border-blue-500 font-medium truncate"
          >
            {item.label}
          </button>
        ))}
