  ...
  return (
    <div className="max-w-2xl mx-auto space-y-10 animate-in zoom-in-95 duration-700">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <Card className="border-none shadow-lg rounded-[2rem] bg-background text-center p-8 space-y-2">
          <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Accuracy</p>
          <p className="text-4xl font-black text-foreground">{accuracy}%</p>
        </Card>
        <Card className="border-none shadow-lg rounded-[2rem] bg-background text-center p-8 space-y-2">
          <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Best Streak</p>
          <p className="text-4xl font-black text-indigo-600">{streak}</p>
        </Card>
        <Card className="border-none shadow-lg rounded-[2rem] bg-background text-center p-8 space-y-2">
          <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Total Answered</p>
      ...
      <div className="flex flex-col sm:flex-row gap-4 pt-4">
        ...
        <Button 
          variant="outline"
          onClick={onExit}
          className="flex-1 h-16 rounded-2xl border-2 border-border font-black text-xs uppercase tracking-widest"
        >
