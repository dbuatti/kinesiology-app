...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 text-[11px] font-medium uppercase tracking-[0.04em] text-muted-foreground",
      inset && "pl-8",
      className,
    )}
    {...props}
...
const DropdownMenuShortcut = ({
  ...
  return (
    <span
      className={cn("ml-auto pl-4 text-[11px] font-medium tracking-wide text-muted-foreground", className)}
      {...props}
    />
  );
};
