...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between gap-2 rounded-lg border border-input bg-card px-3 py-1.5 text-sm shadow-xs transition-[border-color,box-shadow] duration-150 hover:border-foreground/20 placeholder:text-muted-foreground focus:outline-none focus-visible:border-ring/60 focus-visible:ring-[3px] focus-visible:ring-ring/15 data-[state=open]:border-ring/60 data-[state=open]:ring-[3px] data-[state=open]:ring-ring/15 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className,
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("py-1.5 pl-8 pr-2 text-[11px] font-medium uppercase tracking-[0.04em] text-muted-foreground", className)}
    {...props}
  />
));
