...
export const BRAIN_REFLEX_POINTS: BrainReflexPoint[] = [
  ...
  // CRANIAL NERVES
  {
    ...
    acupoint: 'Yin Tang',
    technique: 'Touch the point between the eyebrows.',
    lateralization: 'Bilateral',
  ...
  },
  {
    ...
    acupoint: 'BL2',
    technique: 'Touch the point near the inner eyebrow or shine light into the eyes.',
    lateralization: 'Contralateral',
  ...
  },
  {
    ...
    technique: 'Lightly touch the eyes. Test by having client look up, down, or across the bridge of the nose.',
    lateralization: 'Ipsilateral',
  ...
  },
  {
    ...
    category: 'Cranial Nerve',
    location: 'Eyes (lightly touch).',
    technique: 'Lightly touch the eyes. Test by having client look down towards the tip of the nose.',
    lateralization: 'Ipsilateral',
  ...
  },
  {
    ...
    technique: 'Hand along the cheek/jaw region.',
    lateralization: 'Ipsilateral',
  ...
  },
  {
    ...
    technique: 'Place finger gently in the ear canal.',
    lateralization: 'Ipsilateral',
  ...
  },
  {
    ...
    technique: 'Palpate the belly of levator scapulae or have client hum.',
    lateralization: 'Ipsilateral',
  ...
  },
  {
    ...
    technique: 'Hand along the occiput just below GV16, or deep pressure in the ear against the skin.',
    lateralization: 'Ipsilateral',
  ...
  },
  {
    ...
    technique: 'Tap ipsilateral SCM and contralateral upper trapezius.',
    lateralization: 'Mixed',
  ...
  },
  {
    ...
    technique: 'Touch the area underneath the chin.',
    lateralization: 'Ipsilateral',
