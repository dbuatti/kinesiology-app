...
export const PRIMITIVE_REFLEXES: PrimitiveReflex[] = [
  ...
  },
  {
    ...
    isLateralized: false,
    developmentalWindow: "Birth to 4 months",
    stimulus: 'Head and lumbar spine in extension (Supine).',
    inhibitionPattern: 'Upper and lower body flexors inhibit.',
    howTo: 'Patient supine. Ask patient to actively extend both neck and lumbar spine. Test upper and lower body flexors.',
    description: 'TLR with neck and lumbar spine in extension — assesses flexor inhibition via combined vestibular-spinal input.',
  ...
  },
  {
    ...
    isLateralized: false,
    developmentalWindow: "Birth to 4 months",
    stimulus: 'Head and lumbar spine in flexion (Supine).',
    inhibitionPattern: 'Upper and lower body extensors inhibit.',
    howTo: 'Patient supine. Ask patient to actively flex both neck and lumbar spine. Test upper and lower body extensors.',
    description: 'TLR with neck and lumbar spine in flexion — assesses extensor inhibition via combined vestibular-spinal input.',
    pearl: 'Essential for sensory mapping of the neck. Retained TLR often manifests as sleep issues or "somersaulting" sensations.',
    clinicalSigns: ['Sleep issues', 'Somersaulting sensation', 'Poor posture', 'Dizziness/Vertigo', 'Neck instability'],
    fractalPartners: ['Moro', 'ATNR', 'STNR (Extension)', 'STNR (Flexion)'],
    videoUrl: "https://embed-ssl.wistia.com/deliveries/e408efa2796ae592f7a4e66f18c5fc3f6072865e.mp4",
