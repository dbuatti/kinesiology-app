...
export const TCM_CHANNELS: TcmChannel[] = [
  {
    ...
    muscles: ['Upper Trapezius', 'Anterior Deltoid', 'Pectoralis Major (Clavicular)', 'Pec Minor', 'Abductor Pollicis Brevis'],
  ...
  },
  {
    ...
    muscles: ['Middle Deltoid', 'Adductor Pollicis'],
  ...
  },
  {
    ...
    muscles: ['Triceps', 'Infraspinatus', 'Levator Scapula', 'First Dorsal Interossei', 'Abductor Digiti Minimi'],
  ...
  },
  {
    ...
    muscles: ['Psoas', 'Rectus Abdominals', 'Adductors', 'Quadratus Lumborum', 'Abductor Hallucis'],
  ...
  },
  {
    ...
    muscles: ['Biceps', 'Pectoralis Major (Sternal)', 'Serratus Anterior', 'Diaphragm', 'Gluteus Medius', 'Piriformis', 'Gluteus Minimus', 'Adductors', 'Coracobrachialis', 'Opponens Pollicis'],
  ...
  },
  {
    ...
    muscles: ['Tensor Fasciae Latae (TFL)', 'Piriformis', 'Tibialis Posterior', 'Peroneus Longus', 'Extensor Digitorum Brevis'],
  ...
  },
  {
    ...
    muscles: ['Rhomboids', 'Gracilis', 'Psoas', 'Flexor Digitorum Brevis'],
