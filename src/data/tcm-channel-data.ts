...
export const TCM_CHANNELS: TcmChannel[] = [
  ...
  },
  {
    ...
    muscles: ['Sternocleidomastoid (SCM)', 'Scalenes', 'Neck Extensors', 'Transverse Abdominals', 'External Obs', 'Internal Obs', 'Quadriceps Group', 'Tibialis Anterior', 'Brachioradialis', 'Dorsal Interossei', 'Buccinator', 'Masseter', 'External Pterygoid', 'Orbicularis Oris', 'Occipitalis'],
  ...
  },
  {
    ...
    muscles: ['Latissimus Dorsi', 'Middle Trapezius', 'Lower Trapezius', 'Sartorius'],
  ...
  },
  {
    ...
    muscles: ['Subscapularis', 'Vastus Lateralis'],
  ...
  },
  {
    ...
    muscles: ['Sacrospinalis', 'Multifidi', 'Pelvic Floor', 'Erector Spinae', 'Hamstrings', 'Soleus', 'Gastrocnemius', 'Popliteus', 'Gluteus Maximus'],
  ...
  },
  {
    ...
    muscles: ['Biceps', 'Pectoralis Major (Sternal)', 'Serratus Anterior', 'Diaphragm', 'Gluteus Medius', 'Piriformis', 'Gluteus Minimus', 'Coracobrachialis'],
  ...
  },
  {
    ...
    muscles: ['Teres Minor', 'Posterior Deltoid'],
  ...
  },
  {
    ...
    muscles: ['Tensor Fasciae Latae (TFL)', 'Tibialis Posterior', 'Peroneus'],
