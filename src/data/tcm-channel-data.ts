...
export const TCM_CHANNELS: TcmChannel[] = [
  ...
  },
  {
    ...
    muscles: ['Sternocleidomastoid (SCM)', 'Scalenes', 'Neck Extensors', 'Transverse Abdominals', 'External Obs', 'Internal Obs', 'Rectus Abdominals', 'Quadriceps Group', 'Tibialis Anterior', 'VMO', 'Rec Fem'],
  ...
  },
  {
    ...
    muscles: ['Biceps', 'Pectoralis Major (Sternal)', 'Serratus Anterior', 'Diaphragm', 'Gluteus Medius', 'Piriformis', 'Gluteus Minimus'],
  ...
  },
  {
    ...
    muscles: ['Teres Minor', 'Infraspinatus', 'Posterior Deltoid', 'Flexor Hallucis Longus'],
