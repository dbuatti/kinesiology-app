...
export const TCM_CHANNELS: TcmChannel[] = [
  ...
  },
  {
    ...
    muscles: ['Rectus Abdominals', 'Quadriceps Group', 'Tibialis Anterior', 'Rec Fem', 'VMO'],
  ...
  },
  {
    ...
    muscles: ['Sacrospinalis', 'Multifidi', 'Anterior PF', 'Hamstrings', 'Soleus', 'Gastrocnemius', 'Popliteus', 'Gluteus Maximus'],
  ...
  },
  {
    ...
    muscles: ['Biceps', 'Pectoralis Major (Sternal)', 'Serratus Anterior', 'Diaphragm', 'Piriformis', 'Gluteus Medius'],
  ...
  },
  {
    ...
    muscles: ['Infraspinatus', 'Posterior Deltoid'],
