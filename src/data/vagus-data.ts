...
export const VAGUS_ASSOCIATIONS: VagusAssociation[] = [
  ...
  { spinalSegment: "T3", muscle: "Posterior Deltoid", organ: "Lung", reciprocatingSegment: "T8" },
  { spinalSegment: "T4", muscle: "Anterior Deltoid", organ: "Gall Bladder", reciprocatingSegment: "T7" },
  { spinalSegment: "T5", muscle: "Triceps", organ: "Spleen", reciprocatingSegment: "T6" },
  { spinalSegment: "T6", muscle: "Pec Major Clavicular", organ: "Stomach", reciprocatingSegment: "T5" },
  { spinalSegment: "T7", muscle: "Orbicularis Oris", organ: "Exocrine Pancreas", reciprocatingSegment: "T4" },
  { spinalSegment: "T8", muscle: "Pec Major Sternal", organ: "Liver", reciprocatingSegment: "T3" },
  ...
  { spinalSegment: "T11", muscle: "Flex Hallucis Longus", organ: "Adrenal Cortex", reciprocatingSegment: "C7" },
  ...
  { spinalSegment: "L2", muscle: "Tensor Fascia Lata", organ: "Sigmoid Colon", reciprocatingSegment: "C4" },
  { spinalSegment: "L3", muscle: "Glute Maximus", organ: "Ascending Colon", reciprocatingSegment: "C3" },
