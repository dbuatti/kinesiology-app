 ...
 *,
 ...
 "font-semibold text-xl md:text-2xl tracking-tight hover:underline decoration-2 underline-offset-4 truncate block",
 ...
 <Badge className="bg-destructive text-white border-none font-semibold text-[10px] uppercase tracking-wider px-2 py-0.5 rounded-full animate-pulse shrink-0">
 High Priority
 </Badge>
 )}
 </div>
 ...
 "font-semibold text-[10px] uppercase tracking-wider border-none px-2 py-0.5 rounded-md",
 ...
 ? (isTodaySession ? "text-chart-emerald/60" : "text-chart-emerald") 
 : (isTodaySession ? "text-amber-400" : "text-muted-foreground")
 )}>
 ...
 <Button 
 size="sm" 
 className="bg-white text-indigo-900 hover:bg-muted rounded-xl h-9 px-5 font-semibold text-[10px] uppercase tracking-wider shadow-sm"
 ...
 <DropdownMenuContent align="end" className="rounded-xl p-2 shadow-sm border-none bg-white ">
 ...
 <ExternalLink size={16} className="text-primary" /> View Details
 </Link>
 </DropdownMenuItem>
 <DropdownMenuItem 
 ...
 >
 <CalendarClock size={16} className="text-muted-foreground" /> Reschedule
 </DropdownMenuItem>
 <DropdownMenuItem 
 className="rounded-xl py-2.5 px-4 cursor-pointer flex items-center gap-3"
 onClick={() => handleCopyFullSummary(app)}
 >
 <Copy size={16} className="text-muted-foreground" /> Copy Summary
 </DropdownMenuItem>
 ...
 {hasBolt && (
 <Badge className={cn(
 "border-none font-semibold text-[10px] uppercase tracking-wider px-2 py-0.5 rounded-full flex items-center gap-1.5",
 isTodaySession ? "bg-white/10 text-white" : "bg-chart-primary/10 text-chart-primary"
 )}>
 ...
 <Badge className={cn(
 "border-none font-semibold text-[10px] uppercase tracking-wider px-2 py-0.5 rounded-full flex items-center gap-1.5",
 isTodaySession ? "bg-white/10 text-white" : "bg-chart-destructive/10 text-chart-destructive"
 )}>
 <Activity size={10} /> COH: {app.coherence_score?.toFixed(2)}
 </Badge>
 )}
 <div className={cn(
 "ml-auto text-[10px] font-semibold uppercase tracking-wider opacity-40",
 ...
 <TabsTrigger value="all" className="rounded-lg text-[10px] font-semibold uppercase tracking-wider">All</TabsTrigger>
 <TabsTrigger value="today" className="rounded-lg text-[10px] font-semibold uppercase tracking-wider text-chart-destructive">Today</TabsTrigger>
 <TabsTrigger value="Scheduled" className="rounded-lg text-[10px] font-semibold uppercase tracking-wider">Pending</TabsTrigger>
 <TabsTrigger value="Completed" className="rounded-lg text-[10px] font-semibold uppercase tracking-wider">Done</TabsTrigger>
 </TabsList>
 </Tabs>
 </div>
 ...
 disabled={syncing}
 className="rounded-xl h-12 px-6 font-semibold text-[10px] uppercase tracking-wider border-border text-chart-primary hover:bg-muted"
 >
 ...
 <Button className="bg-primary hover:bg-primary/90 shadow-sm rounded-xl h-12 px-8 font-semibold text-xs uppercase tracking-wider">
 <Plus size={20} className="mr-2" /> New Session
 </Button>
 </DialogTrigger>
 <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto rounded-xl p-0">
 <div className="p-8">
 <DialogHeader className="mb-6">
 <DialogTitle className="text-2xl font-semibold">Schedule New Session</DialogTitle>
 ...
 variant="outline"
 className="h-14 px-10 rounded-xl font-semibold text-xs uppercase tracking-wider border-border text-chart-primary hover:bg-muted shadow-sm"
 >
 {loadingMore ? (
 ...
 <DialogContent className="sm:max-w-[550px] max-h-[90vh] overflow-y-auto rounded-xl p-0">
 <div className="p-8">
 <DialogHeader className="mb-6">
 ...
 <div>
 <DialogTitle className="text-2xl font-semibold">Reschedule Session</DialogTitle>
