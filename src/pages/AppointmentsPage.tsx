                        ...
                        <div className="flex flex-col sm:flex-row sm:items-stretch">
                          <Link to={`/appointments/${app.id}`} className="p-6 flex-1 space-y-4">
                            ...
                            {hasAnyAssessment && (
                              <div className="flex flex-wrap gap-2 pt-2 border-t border-slate-100">
                                ...
                                {hasCogs && (
                                  <Badge className="bg-purple-100 text-purple-700 hover:bg-purple-200 border-none flex items-center gap-1 text-[10px] font-bold">
                                    <Move size={10} /> COGS
                                  </Badge>
                                )}
                                {(hasFakuda || hasRhombergs || hasFrontalLobe) && (
                                  <Badge className="bg-green-100 text-green-700 hover:bg-green-200 border-none flex items-center gap-1 text-[10px] font-bold">
                                    <Brain size={10} /> NEURO
                                  </Badge>
                                )}
                              </div>
                          ...
                          <div className="p-6 flex flex-col justify-between items-end border-t sm:border-t-0 sm:border-l border-slate-100 bg-slate-50/30">
                            ...
                            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                              ID: {(app as any).display_id || app.id.slice(0,8)}
                            </span>
                          </div>
                        </div>
                      </CardContent>
