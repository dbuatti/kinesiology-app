      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="flex items-center justify-between">
          ...
          <Button 
            ...
            className="bg-rose-600 hover:bg-rose-700 rounded-xl font-bold shadow-lg shadow-rose-100"
          >
        ...
        <div className="space-y-2">
          <h1 className="text-4xl font-black tracking-tight text-slate-900">Fear & Creativity</h1>
          <p className="text-slate-500 font-medium text-lg">Your history of awareness and integration.</p>
        </div>
        ...
        {loading ? (
              ...
              >
                <CardContent className="p-6 flex items-center justify-between">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3 mt-1">
                        ...
                        <Badge variant="secondary" className="bg-slate-100 text-slate-500 border-none text-[8px] font-black uppercase tracking-widest">
                          {Object.keys(sub.form_data || {}).length} Responses
                        </Badge>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <div className="w-10 h-10 rounded-xl bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-rose-600 group-hover:text-white transition-all">
                      <ArrowRight size={20} />
                    </div>
                  </div>
                </CardContent>
          ...
          <div className="text-center py-32 bg-white rounded-[3rem] border-2 border-dashed border-slate-200">
            <div className="w-20 h-20 bg-rose-50 rounded-3xl flex items-center justify-center mx-auto mb-6 text-rose-300">
              <Heart size={40} />
            </div>
            <h3 className="text-xl font-black text-slate-900">No reflections yet</h3>
            <p className="text-slate-500 mt-2 mb-8 max-w-xs mx-auto">Start your first Fear & Creativity awareness exercise to begin tracking your growth.</p>
            <Button 
              onClick={() => setIsCreating(true)}
              className="bg-rose-600 hover:bg-rose-700 rounded-xl font-bold h-12 px-8"
            >
              Create First Entry
            </Button>
          </div>
