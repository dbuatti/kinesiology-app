      ...
      <Tabs value={activeTab} onValueChange={(v) => setSearchParams({ tab: v })} className="w-full">
        <div className="overflow-x-auto pb-4">
          <TabsList className="flex w-max h-auto p-1.5 bg-slate-200/50 rounded-2xl gap-1">
            ...
            <TabsTrigger value="bible" className="rounded-xl py-2.5 px-6 data-[state=active]:bg-white data-[state=active]:text-indigo-600 data-[state=active]:shadow-sm font-bold text-xs uppercase tracking-widest">
              <BookOpen size={16} className="mr-2" /> Mechano Bible
            </TabsTrigger>
        ...
        <TabsContent value="bible" className="mt-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <MechanoBible />
        </TabsContent>
