    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <main className="relative z-10 max-w-3xl mx-auto px-6 md:px-12 pb-24">
        ...
        <section className="mb-16">
          <h2 className="text-xs font-medium text-muted-foreground mb-6 text-center">Who this is for</h2>
        ...
        <section className="mb-16">
          <h2 className="text-xs font-medium text-muted-foreground mb-6 text-center">What actually happens</h2>
        ...
        <section className="mb-16 max-w-xl mx-auto text-center">
          <h2 className="text-xs font-medium text-muted-foreground mb-6">How long this takes</h2>
        ...
        <section className="mb-16 max-w-xl mx-auto">
          <h2 className="text-xs font-medium text-muted-foreground mb-6 text-center">What this isn't</h2>
        ...
        <div className="max-w-2xl mx-auto border-t border-border pt-14 mb-16 flex flex-col items-center text-center">
          <img
            ...
            loading="lazy"
          />
          <h2 className="text-xs font-medium text-muted-foreground mb-4">About</h2>
          <p className="text-base text-muted-foreground leading-relaxed mb-4">
        ...
        <section className="max-w-xl mx-auto mb-16">
          <h2 className="text-xs font-medium text-muted-foreground mb-6 text-center">Questions</h2>
