...
const OnboardingSuccessPage = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-muted px-6 py-16">
      <div className="w-full max-w-md bg-background rounded-2xl shadow-xl overflow-hidden text-center">
        ...
        <div className="p-10 sm:p-12">
          ...
          <div className="text-[11px] font-semibold tracking-wider uppercase text-chart-primary mb-3">
            Payment Received
          </div>
          <h1 className="text-2xl font-semibold text-foreground mb-3">You're all set!</h1>
          ...
          <div className="mt-8 pt-6 border-t border-border text-left">
            ...
            <div className="text-chart-primary text-[11px] font-semibold tracking-wider uppercase">
